...
/***/ function(module, exports, __webpack_require__) {
	...
	var _episodes = __webpack_require__(3);

	var _episodes2 = _interopRequireDefault(_episodes);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var EpisodeList = __webpack_require__(4);
	var EpisodeCount = __webpack_require__(6);
	var CharacterList = __webpack_require__(7);
	var Resetit = __webpack_require__(16);
	var remainingEps = [];
	var remainingChars = [];
	...
	var EpisodeSelect = React.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    this.setState({
	      remainingChars: _characters2.default.characters,
	      remainingEps: _episodes2.default
	    });
	  },
	  ...
	  handleClick: function handleClick(character) {
	    ...
	    if (this.state.selected.indexOf(character) < 0 && this.state.selected.length < 3) {
	      ...
	      this.episodeRidder(_episodes2.default.episodes, _characters2.default.characters);
	    }
	  },
	...
	module.exports = {
	    episodes: [
	      ...
	      },
	        {
	          seasonNum: "1",
	          episodeNum: "3",
	          title: "Homers Odeyssy",
	          character: ["Homer", "Marge", "Burns"],
	          picture1: "./public/images/Homer.jpg",
	          picture2: "./public/images/Marge.jpg",
	          picture3: "./public/images/Burns.jpg",
	      ...
	      },
	        {
	          ...
	          character: ["Homer", "Marge", "Marvin"],
	          picture1: "./public/images/Homer.jpg",
	          picture2: "./public/images/Marge.jpg",
	          picture3: "./public/images/Marvin.jpg",
	      ...
	      },
	        {
	          ...
	          character: ["Bart", "Nelson", "Abe"],
	          picture1: "./public/images/Bart.jpg",
	          picture2: "./public/images/Nelson.jpg",
	          picture3: "./public/images/Abe.jpg",
	          Description: "Bart runs afoul of Nelson Muntz, the school bully, who begins attacking Bart every day after school. Homer suggests fighting back, which does not work. Desperate for a solution, Bart visits Grampa for advice. Grampa takes Bart to meet Herman, who suggests that Bart rally all of the school children and declare war on Nelson. Bart and his army attack Nelson and successfully manage to convince him to give up his bullying ways"
	      },
	        {
	          seasonNum: "1",
	          episodeNum: "6",
	          title: "Moaning Lisa",
	          character: ["Lisa", "Murphy"],
	          picture1: "./public/images/Lisa.jpg",
	          picture2: "./public/images/Murphy.jpg",
	      ...
	      },
	        {
	          ...
	          character: ["Homer", "Flanders", "Bart"],
	          picture1: "./public/images/Homer.jpg",
	          picture2: "./public/images/Flanders.jpg",
	      ...
	      },
	        {
	          ...
	          character: ["Bart", "Jimbo", "Homer"],
	          picture1: "./public/images/Bart.jpg",
	          picture2: "./public/images/Jimbo.jpg",
	          picture3: "./public/images/Homer.jpg",
	      ...
	      },
	        {
	          ...
	          character: ["Marge", "Jacques", "Homer"],
	          picture1: "./public/images/Marge.jpg",
	          picture2: "./public/images/Jaques.jpg",
	          picture3: "./public/images/Homer.jpg",
	      ...
	      },
	        {
	          ...
	          character: ["Homer", "Cesar", "Ugolin"],
	          picture1: "./public/images/Homer.jpg",
	          picture2: "./public/images/Cesar.jpg",
	          picture3: "./public/images/Ugolin.jpg",
	      ...
	      },
	        {
	          ...
	          character: ["Krusty", "Bob", "Bart"],
	          picture1: "./public/images/Krusty.jpg",
	          picture2: "./public/images/Bob.jpg",
	          picture3: "./public/images/Bart.jpg",
	      ...
	      },
	        {
	          ...
	          character: ["Bart", "Lisa", "Botz"],
	          picture1: "./public/images/Bart.jpg",
	          picture2: "./public/images/Lisa.jpg",
	          picture3: "./public/images/Botz.jpg",
	          Description: "While Christmas shopping, Bart sneaks off and gets a tattoo. Marge soon discovers this and uses the family's Christmas savings to get it removed. Meanwhile, Homer discovers that he will not be getting a Christmas bonus from Mr. Burns and thus the family has no money to buy Christmas presents. He decides to keep their financial troubles a secret and gets a job as a department store Santa, but later discovers that the job does not pay enough. Desperate for a miracle, Homer and Bart go to the dog racing track on Christmas Eve in hopes of earning some money. He bets it all on a longshot named Santa's Little Helper, who loses. Santa's Little Helper's owner furiously disowns the dog for completing last and Homer lets Bart keep him. Later on, Homer attempts to come clean to everyone, but Bart exclaims that they have a dog and everyone happily welcomes the newest member of the Simpson family."
	      },
	      {
	          seasonNum: "2",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Episode = __webpack_require__(5);
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "div",
	        { className: "picList" },
	        React.createElement("img", { className: "smallImg", src: this.props.picture1 }),
	        React.createElement("img", { className: "smallImg", src: this.props.picture2 }),
	        React.createElement("img", { className: "smallImg", src: this.props.picture3 })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Character = __webpack_require__(8);
